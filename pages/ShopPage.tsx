...
const ShopPage: React.FC = () => {
  ...
  const subCategories = ['all', 'jerseys', 'hoodies', 't-shirts'];
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
      {loading ? (
        ...
        <>
          ...
          {/* Subcategory Tabs */}
          <div className="flex gap-2 pb-4 border-b border-zinc-200 dark:border-zinc-800 overflow-x-auto scrollbar-hide mb-8">
