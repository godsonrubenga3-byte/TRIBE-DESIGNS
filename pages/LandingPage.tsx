    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-4">
          <span className="inline-block mb-4 px-4 py-1.5 rounded-full bg-amber-500 text-black text-xs font-black tracking-widest uppercase animate-pulse">
            NEW DROP: THE HERITAGE PACK
          </span>
          <h1 className="text-6xl md:text-9xl font-syne font-extrabold text-white tracking-tighter mb-6 leading-none uppercase">
            WEAR YOUR <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-600">SPIRIT.</span>
          </h1>
          <p className="text-zinc-300 max-w-xl mx-auto text-lg mb-10 font-medium">
            Custom-made jerseys that bridge the gap between ancient African artistry and modern street culture.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              to="/shop" 
              className="px-10 py-5 bg-white text-black font-syne font-black text-lg tracking-widest hover:bg-amber-500 transition-all rounded-none transform -skew-x-12"
            >
              SHOP COLLECTION
            </Link>
            <Link 
              to="/customize" 
              className="px-10 py-5 border-2 border-white text-white font-syne font-black text-lg tracking-widest hover:bg-white hover:text-black transition-all rounded-none transform -skew-x-12"
            >
              CUSTOMIZE YOURS
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="group p-8 border border-zinc-100 dark:border-zinc-800 rounded-3xl hover:border-amber-500/50 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-900/50">
                <div className="mb-6 transform group-hover:scale-110 transition-transform">{feature.icon}</div>
                <h3 className="text-2xl font-syne font-extrabold mb-4">{feature.title}</h3>
      ...
      {/* AI Teaser Section */}
      <section className="py-24 px-6 relative overflow-hidden bg-amber-500 group">
        <div className="absolute top-0 right-0 p-20 opacity-10">
          <Sparkles className="w-96 h-96 text-black" />
        </div>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
          <div className="md:max-w-xl mb-12 md:mb-0">
            <h2 className="text-5xl md:text-7xl font-syne font-black text-black leading-none mb-8">
              AI-POWERED <br /> DESIGN <br /> ASSISTANT
            </h2>
            <p className="text-black/80 text-xl font-bold mb-8">
              Don't know where to start? Tell our AI your vibe and it will suggest a custom jersey concept rooted in your heritage.
            </p>
            <Link 
              to="/customize" 
              className="inline-flex items-center space-x-4 bg-black text-white px-8 py-4 font-black tracking-widest hover:px-10 transition-all shadow-xl"
            >
          ...
          <div className="relative">
            <div className="w-72 h-96 bg-zinc-900 rounded-2xl rotate-6 overflow-hidden shadow-2xl border-4 border-black">
      ...
      <section className="py-32 bg-zinc-950 text-white text-center px-6 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
            <div className="absolute top-10 left-10 w-64 h-64 rounded-full bg-blue-500 blur-3xl mix-blend-screen"></div>
            <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-purple-500 blur-3xl mix-blend-screen"></div>
        </div>

        <div className="relative z-10 max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-8xl font-syne font-black mb-8 uppercase italic tracking-tighter">
                JOIN THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">TRIBE.</span>
            </h2>
            <p className="text-zinc-400 max-w-lg mx-auto mb-12 text-lg font-medium leading-relaxed">
            ...
            <form onSubmit={handleJoin} className="max-w-xl mx-auto relative group">
                ...
                <div className="relative flex p-2 bg-black rounded-2xl border border-zinc-800 shadow-2xl">
                    <input 
                        type="email" 
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        placeholder="ENTER YOUR EMAIL" 
                        className="flex-1 bg-transparent px-6 py-4 focus:outline-none text-white font-bold uppercase placeholder:text-zinc-600 tracking-widest"
                        required
                    />
                    <button type="submit" className="bg-amber-500 text-black px-8 py-4 rounded-xl font-black uppercase tracking-widest hover:bg-white transition-colors shadow-lg flex items-center gap-2">
