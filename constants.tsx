...
export const JERSEYS: Product[] = [
  // --- HERITAGE: JERSEYS ---
  {
    ...
    price: 120,
    image: 'https://images.unsplash.com/photo-1551854269-9dd93eb6b17a?auto=format&fit=crop&q=80&w=800',
    category: 'Heritage',
    subcategory: 'jerseys',
  ...
  },
  {
    ...
    price: 115,
    image: 'https://images.unsplash.com/photo-1620799140408-ed5341cd2431?auto=format&fit=crop&q=80&w=800', // Placeholder fabric shot
    category: 'Heritage',
    subcategory: 'jerseys',
